...
# Prepare BDN dataset for WHU-CD 40%

config_path = "/data/suyou/Codes/BIBR/configs/whu.yaml"
labeled_id_path = "/data/suyou/Codes/BIBR/splits/whu/40%/labeled.txt"
cd_save_path = "/data/suyou/Codes/BIBR/exp/whu/pretrained"                         # Pretrained CD model for Contour Extract and Match

# Training dataset save path
txt_save_path = "/data/suyou/Codes/BIBR"
patches_save_path = "/data/suyou/Codes/datasets/BIBR-WHU/train/patches"
label_save_path = "/data/suyou/Codes/datasets/BIBR-WHU/train/label"
local_rank = 0
port = "8090"
...
if __name__ == "__main__":
    # Prepare contour dataset for WHU-CD
    main()