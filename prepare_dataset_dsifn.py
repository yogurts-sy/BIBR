...
# Prepare BDN dataset for DSIFN-CD 40%

config_path = "/data/suyou/Codes/BIBR/configs/dsifn.yaml"
labeled_id_path = "/data/suyou/Codes/BIBR/splits/dsifn/40%/labeled.txt"
cd_save_path = "/data/suyou/Codes/BIBR/exp/dsifn/pretrained"                         # Pretrained CD model for Contour Extract and Match

# Training dataset save path
txt_save_path = "/data/suyou/Codes/BIBR"
patches_save_path = "/data/suyou/Codes/datasets/BIBR-DSIFN/train/patches"
label_save_path = "/data/suyou/Codes/datasets/BIBR-DSIFN/train/label"
local_rank = 0
port = "8090"
...
if __name__ == "__main__":
    # Prepare contour dataset for DSIFN-CD
    main()