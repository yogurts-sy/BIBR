...
# 40% LEVIR-CD cropped for BDN

config_path = "/data/suyou/Codes/BIBR/configs/levir_deeplabv3plus.yaml"
labeled_id_path = "/data/suyou/Codes/BIBR/splits/levir/BIBR/train40_labeled.txt"
unlabeled_id_path = "/data/suyou/Codes/BIBR/splits/levir/BIBR/train40_unlabeled.txt"
val_id_path = "/data/suyou/Codes/BIBR/splits/levir/BIBR/test.txt"
save_path = "/data/suyou/Codes/BIBR/exp/levir/bibr/bibr_training40_0.02_16"
...
def evaluate(model, loader, cfg):
    ...
    iou_class = intersection_meter.sum / (union_meter.sum + 1e-10) * 100.0      # iou = intersection / union
    overall_acc = correct_pixel.sum / total_pixel.sum * 100.0                   # 只要pred的范围比mask的大，这个值就很高
...
if __name__ == '__main__':
    ...
    main() 
    # python unimatch_deeplabv3plus_levir.py 2>&1 | tee train_levir40_0.02_16.log
